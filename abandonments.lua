...
generate_storage_hut ("weapons2-mini-gun", loothutboundingbox, 12,
{
...
generate_storage_hut ("weapons3-mini-gun", loothutboundingbox, 13,
{
	...
	{item = "chaingun-ammo-piercing", probability = 0.5, count_min = 50, count_max = 200},
}),
generate_storage_hut ("weapons4-mini-gun", loothutboundingbox, 14,
{
...
{
	{item = "he-grenade", probability =  1, count_min = 15, count_max = 30},
	{item = "he-grenade", probability = 0.75, count_min = 5, count_max = 30},
	{item = "flak-grenade", probability =  0.5, count_min = 5, count_max = 30},
}),
...
generate_storage_hut ("grenades4", loothutboundingbox, 11,
{
	...
	{item = "mirv-grenade", probability = 1, count_min = 5, count_max = 10},
